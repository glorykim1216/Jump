...
Shader "ASESampleShaders/ScreenSpaceDetail"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( float4( UnpackNormal( tex2D( _Albedo, uv_Albedo ) ) , 0.0 ) * tex2D( _Checkers, ( (ase_screenPosNorm).xy * float2( 13.71,6 ) ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=15600
3847;7;1906;1004;1519.849;336.8716;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;10;-992,272;Float;False;Constant;_Vector0;Vector 0;-1;0;Create;True;0;0;False;0;13.71,6;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;1;-537.3115,-80;Float;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;False;0;None;10ff51d2d87fb7b46b70b55f8551c146;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-192,32;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5D17E0BFC2CCFA29BE5D8590D0AA884DA112B397